      ...
      <div className={styles.rightPanel}>
        < div className={styles.formCard}>
          ...
          <div className={styles.logo}>
            <img src={assets.logo} alt="Rani Oak" />
          </div>

          <h2 className={styles.title}>Create Account <span className={styles.titleHeart}>♡</span>
          </h2>
          <p className={styles.subtitle}>Join the sweetest community!</p>

          <div className={styles.dividerOrnament}>
            <span className={styles.dividerLine} />
            <span className={styles.dividerIcon}><IconSparkle /></span>
            <span className={styles.dividerLine} />
          </div>
