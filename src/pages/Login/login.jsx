...
const DecoHeart = () => (
  <svg className={styles.decoHeart} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 21.593c-5.63-5.539-11-10.297-11-14.402 0-3.791 3.068-5.191 5.281-5.191 1.312 0 4.151.501 5.719 4.457 1.59-3.968 4.464-4.447 5.726-4.447 2.54 0 5.274 1.621 5.274 5.181 0 4.069-5.136 8.625-11 14.402z" />
  </svg>
);

const DecoLeaf = () => (
  <svg className={styles.decoLeaf} viewBox="0 0 80 80" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M40 70 C40 70 10 50 15 25 C20 5 40 10 40 10 C40 10 60 5 65 25 C70 50 40 70 40 70Z" />
    <line x1="40" y1="10" x2="40" y2="70" />
    <path d="M40 30 C30 35 20 32 15 25" />
    <path d="M40 45 C50 40 60 42 65 35" />
  </svg>
);

const DecoLines = () => (
  <svg className={styles.decoLines} width="40" height="30" viewBox="0 0 40 30" fill="none">
    <line x1="0" y1="5" x2="40" y2="5" stroke="#e8390e" strokeWidth="2" strokeLinecap="round" opacity="0.4" />
    <line x1="0" y1="15" x2="30" y2="15" stroke="#e8390e" strokeWidth="2" strokeLinecap="round" opacity="0.3" />
    <line x1="0" y1="25" x2="20" y2="25" stroke="#e8390e" strokeWidth="2" strokeLinecap="round" opacity="0.2" />
  </svg>
);
  ...
  return (
    <div className={styles.loginPage}>
      ...
      <div className={styles.leftPanel}>
        ...
        <div className={styles.tagline}>Good Food. Good Mood.</div>
